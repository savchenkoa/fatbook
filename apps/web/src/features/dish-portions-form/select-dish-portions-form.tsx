...
import { updateDish } from "@fatbook/api-client";
...
export function SelectDishPortionsForm({
    ...
    const dishPortions: DishPortion[] = dishes.map((d) => mapDishToPortionInputs(d));
    ...
    return (
        <>
            <HeaderBox title={title} subtitle={subtitle} backRoute={backRoute} className="mb-4">
