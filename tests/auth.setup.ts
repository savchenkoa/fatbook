...
invariant(process.env.E2E_TEST_EMAIL, "E2E_TEST_EMAIL must be set in .env.test");
invariant(process.env.E2E_TEST_PASSWORD, "E2E_TEST_PASSWORD must be set in .env.test");
